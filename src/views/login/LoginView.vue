  ...
  <div class="login-container">
      ...
      <div class="brand-content">
        <div class="brand-logo">
          <svg class="logo-icon" viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
              d="M35 70 Q40 45 60 40 Q80 45 85 70 Q85 80 75 85 L45 85 Q35 80 35 70Z"
              fill="none"
              stroke="#ffffff"
              stroke-width="2.5"
            />
    ...
    <div class="login-form-area">
      <div class="form-wrapper">
        <LoginForm />
        <div class="copyright">
          <span>&copy; {{ currentYear }} 猪肉产品质量安全溯源系统 版权所有</span>
        </div>
      </div>
    </div>
  </div>
...
.login-container {
  ...
  min-height: 600px;
  overflow: hidden;
  background: linear-gradient(135deg, #0a1628 0%, #122a50 40%, #0d3b6e 70%, #0a1628 100%);
}
...
.login-form-area {
  ...
  &::before {
    ...
    width: 3px;
    height: 100%;
    background: linear-gradient(180deg, #409eff, #337ecc, #409eff);
  }
}
